...
const BytechCoinUtils = require('../').CryptoNote
const config = require('../config.json')
const cnUtil = new BytechCoinUtils(config)
...
const testAddress = 'bYTCv37MHCKFsieeLBh62wi8vFZVUFEYpaxjf37YZ5whVLd8eF9oMS1agvuackfvVq7LvSyr4Eqt2BEysmFVskavDqCe74xMraL'
